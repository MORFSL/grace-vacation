...
export const TourGalleryLightbox = ({ media, open, onOpenChange, initialIndex = 0 }: Props) => {
          ...
          {typeof media[currentIndex] === 'object' && (
            <div className="relative w-full h-full md:max-w-[85vw] md:max-h-[80vh] flex items-center justify-center">
              <Media
                ...
                className="h-full"
                imgClassName="object-contain w-full h-full md:max-w-[85vw] md:max-h-[80vh] md:rounded-xl shadow-2xl"
                videoClassName="object-contain w-full h-full md:max-w-[85vw] md:max-h-[80vh] md:rounded-xl shadow-2xl"
              />
            </div>
          )}
        </div>
