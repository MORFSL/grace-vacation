...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_general_testimonials_platform" AS ENUM('Google Reviews', 'Trip Advisor', 'Facebook');
  CREATE TYPE "public"."enum_header_nav_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_header_cta_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_footer_nav_items_item_links_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_highlights_carousel_highlights" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_highlights_carousel" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_highlights_carousel_highlights" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_highlights_carousel" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "itineraries_benefits_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"benefit" varchar
  ...
  CREATE TABLE IF NOT EXISTS "itineraries_inclusions_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"inclusion" varchar
  ...
  CREATE TABLE IF NOT EXISTS "itineraries_exclusions_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"exclusion" varchar
  ...
  CREATE TABLE IF NOT EXISTS "itineraries_milestones" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_itineraries_v_version_benefits_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"benefit" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_itineraries_v_version_inclusions_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"inclusion" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_itineraries_v_version_exclusions_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"exclusion" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_itineraries_v_version_milestones" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_itineraries_v" (
  	...
  	"version_exclusions_title" varchar,
  	"version_map_embed" varchar,
  	"version_meta_title" varchar,
  	"version_meta_image_id" integer,
  	"version_meta_description" varchar,
  	"version_published_at" timestamp(3) with time zone,
  ...
  CREATE TABLE IF NOT EXISTS "general" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"testimonials_platform" "enum_general_testimonials_platform",
  	"testimonials_rating" numeric,
  ...
  CREATE TABLE IF NOT EXISTS "footer_nav_items_item_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_nav_items_item_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "footer_payment_methods_method" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"method" varchar,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_highlights_carousel_highlights" ADD CONSTRAINT "pages_blocks_highlights_carousel_highlights_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_highlights_carousel_highlights" ADD CONSTRAINT "pages_blocks_highlights_carousel_highlights_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_highlights_carousel"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_highlights_carousel" ADD CONSTRAINT "pages_blocks_highlights_carousel_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_highlights_carousel_highlights" ADD CONSTRAINT "_pages_v_blocks_highlights_carousel_highlights_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_highlights_carousel_highlights" ADD CONSTRAINT "_pages_v_blocks_highlights_carousel_highlights_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_highlights_carousel"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_highlights_carousel" ADD CONSTRAINT "_pages_v_blocks_highlights_carousel_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "tags" ADD CONSTRAINT "tags_image_icon_id_media_id_fk" FOREIGN KEY ("image_icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "itineraries_benefits_items" ADD CONSTRAINT "itineraries_benefits_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."itineraries"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "itineraries_inclusions_items" ADD CONSTRAINT "itineraries_inclusions_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."itineraries"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "itineraries_exclusions_items" ADD CONSTRAINT "itineraries_exclusions_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."itineraries"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "itineraries_milestones" ADD CONSTRAINT "itineraries_milestones_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."itineraries"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "itineraries" ADD CONSTRAINT "itineraries_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_itineraries_v_version_benefits_items" ADD CONSTRAINT "_itineraries_v_version_benefits_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_itineraries_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_itineraries_v_version_inclusions_items" ADD CONSTRAINT "_itineraries_v_version_inclusions_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_itineraries_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_itineraries_v_version_exclusions_items" ADD CONSTRAINT "_itineraries_v_version_exclusions_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_itineraries_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_itineraries_v_version_milestones" ADD CONSTRAINT "_itineraries_v_version_milestones_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_itineraries_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_itineraries_v" ADD CONSTRAINT "_itineraries_v_version_meta_image_id_media_id_fk" FOREIGN KEY ("version_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "footer_nav_items_item_links" ADD CONSTRAINT "footer_nav_items_item_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_nav_items"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "footer_payment_methods_method" ADD CONSTRAINT "footer_payment_methods_method_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "footer_payment_methods_method" ADD CONSTRAINT "footer_payment_methods_method_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_features_features_image_idx" ON "pages_blocks_features_features" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_highlights_carousel_highlights_order_idx" ON "pages_blocks_highlights_carousel_highlights" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_highlights_carousel_highlights_parent_id_idx" ON "pages_blocks_highlights_carousel_highlights" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_highlights_carousel_highlights_image_idx" ON "pages_blocks_highlights_carousel_highlights" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_highlights_carousel_order_idx" ON "pages_blocks_highlights_carousel" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_highlights_carousel_parent_id_idx" ON "pages_blocks_highlights_carousel" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_highlights_carousel_path_idx" ON "pages_blocks_highlights_carousel" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_features_features_image_idx" ON "_pages_v_blocks_features_features" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_highlights_carousel_highlights_order_idx" ON "_pages_v_blocks_highlights_carousel_highlights" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_highlights_carousel_highlights_parent_id_idx" ON "_pages_v_blocks_highlights_carousel_highlights" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_highlights_carousel_highlights_image_idx" ON "_pages_v_blocks_highlights_carousel_highlights" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_highlights_carousel_order_idx" ON "_pages_v_blocks_highlights_carousel" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_highlights_carousel_parent_id_idx" ON "_pages_v_blocks_highlights_carousel" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_highlights_carousel_path_idx" ON "_pages_v_blocks_highlights_carousel" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "tags_image_icon_idx" ON "tags" USING btree ("image_icon_id");
  ...
  CREATE INDEX IF NOT EXISTS "itineraries_benefits_items_order_idx" ON "itineraries_benefits_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "itineraries_benefits_items_parent_id_idx" ON "itineraries_benefits_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "itineraries_inclusions_items_order_idx" ON "itineraries_inclusions_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "itineraries_inclusions_items_parent_id_idx" ON "itineraries_inclusions_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "itineraries_exclusions_items_order_idx" ON "itineraries_exclusions_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "itineraries_exclusions_items_parent_id_idx" ON "itineraries_exclusions_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "itineraries_milestones_order_idx" ON "itineraries_milestones" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "itineraries_milestones_parent_id_idx" ON "itineraries_milestones" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "itineraries_image_idx" ON "itineraries" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "itineraries_meta_meta_image_idx" ON "itineraries" USING btree ("meta_image_id");
  CREATE INDEX IF NOT EXISTS "itineraries_slug_idx" ON "itineraries" USING btree ("slug");
  ...
  CREATE INDEX IF NOT EXISTS "_itineraries_v_version_benefits_items_order_idx" ON "_itineraries_v_version_benefits_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_itineraries_v_version_benefits_items_parent_id_idx" ON "_itineraries_v_version_benefits_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_itineraries_v_version_inclusions_items_order_idx" ON "_itineraries_v_version_inclusions_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_itineraries_v_version_inclusions_items_parent_id_idx" ON "_itineraries_v_version_inclusions_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_itineraries_v_version_exclusions_items_order_idx" ON "_itineraries_v_version_exclusions_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_itineraries_v_version_exclusions_items_parent_id_idx" ON "_itineraries_v_version_exclusions_items" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_itineraries_v_version_milestones_order_idx" ON "_itineraries_v_version_milestones" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_itineraries_v_version_milestones_parent_id_idx" ON "_itineraries_v_version_milestones" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_itineraries_v_parent_idx" ON "_itineraries_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_itineraries_v_version_version_image_idx" ON "_itineraries_v" USING btree ("version_image_id");
  CREATE INDEX IF NOT EXISTS "_itineraries_v_version_meta_version_meta_image_idx" ON "_itineraries_v" USING btree ("version_meta_image_id");
  CREATE INDEX IF NOT EXISTS "_itineraries_v_version_version_slug_idx" ON "_itineraries_v" USING btree ("version_slug");
  ...
  CREATE INDEX IF NOT EXISTS "_itineraries_v_autosave_idx" ON "_itineraries_v" USING btree ("autosave");
  ...
  CREATE INDEX IF NOT EXISTS "footer_nav_items_item_links_order_idx" ON "footer_nav_items_item_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "footer_nav_items_item_links_parent_id_idx" ON "footer_nav_items_item_links" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "footer_payment_methods_method_order_idx" ON "footer_payment_methods_method" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "footer_payment_methods_method_parent_id_idx" ON "footer_payment_methods_method" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "footer_payment_methods_method_image_idx" ON "footer_payment_methods_method" USING btree ("image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_highlights_carousel_highlights" CASCADE;
  DROP TABLE "pages_blocks_highlights_carousel" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_highlights_carousel_highlights" CASCADE;
  DROP TABLE "_pages_v_blocks_highlights_carousel" CASCADE;
  ...
  DROP TABLE "itineraries_benefits_items" CASCADE;
  DROP TABLE "itineraries_inclusions_items" CASCADE;
  DROP TABLE "itineraries_exclusions_items" CASCADE;
  DROP TABLE "itineraries_milestones" CASCADE;
  DROP TABLE "itineraries" CASCADE;
  DROP TABLE "itineraries_rels" CASCADE;
  DROP TABLE "_itineraries_v_version_benefits_items" CASCADE;
  DROP TABLE "_itineraries_v_version_inclusions_items" CASCADE;
  DROP TABLE "_itineraries_v_version_exclusions_items" CASCADE;
  DROP TABLE "_itineraries_v_version_milestones" CASCADE;
  DROP TABLE "_itineraries_v" CASCADE;
  DROP TABLE "_itineraries_v_rels" CASCADE;
  ...
  DROP TABLE "footer_nav_items_item_links" CASCADE;
  DROP TABLE "footer_nav_items" CASCADE;
  DROP TABLE "footer_payment_methods_method" CASCADE;
  ...
  DROP TYPE "public"."enum_general_testimonials_platform";
  DROP TYPE "public"."enum_header_nav_items_link_type";
  DROP TYPE "public"."enum_header_cta_type";
  DROP TYPE "public"."enum_footer_nav_items_item_links_link_type";`)
}
